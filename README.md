...
### Para criar o Vault precisara de um S3 bucket e access_key, secret_key e deverá ser configurado no arquivo vault.yaml: linhas 6 e 7 e para o S3 na linha 80
